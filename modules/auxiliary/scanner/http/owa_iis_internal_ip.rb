...
class MetasploitModule < Msf::Auxiliary
  ...
  def get_ip_extract
    ...
    urls.each do |url|
      ...
      next unless res && ((res.code > 300) && (res.code < 310)) && (match = res['Location'].match(%r{^https?://(192\.168\.[0-9]{1,3}\.[0-9]{1,3}|10\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}|172\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3})/}i))
