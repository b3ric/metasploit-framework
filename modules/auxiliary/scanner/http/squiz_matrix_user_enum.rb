...
class MetasploitModule < Msf::Auxiliary
  ...
  def do_enum(asset)
    ...
    if datastore['VERBOSE']
      if (res && ((res.code = 403)) && res.body && res.body =~ (%r{You do not have permission to access <i>(\w+)</i>}))
    ...
    if (res && ((res.code = 403)) && res.body && res.body =~ (%r{You do not have permission to access <i>~(\w+)</i>}))
      ...
      if (res && ((res.code = 403)) && res.body && res.body =~ (%r{You do not have permission to access <i>Inbox</i>}))
        tmpasset = asset - 2
        res = send_request_cgi({
          'uri' => "#{uri}?a=#{tmpasset}",
          'method' => 'GET'
        ...
        if (res && ((res.code = 403)) && res.body && res.body =~ (%r{You do not have permission to access <i>(.*)</i>}))
